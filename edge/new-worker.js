...
* Free VPN On Workers 
*
* Grateful to github.com/yonggekkk for this script.
* Edit by github.com/NiREvil.
*
*/
// @ts-ignore
...
// و در لاین زیر (-هجدهم-) شده جایگذاری کنید

let userID = 'd5d5c3d6-0367-442d-800f-9d013154667d';
...
const proxyIPs = ['176.97.77.32']; // ['cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org'];
...
function getVLESSConfig(userID, hostName) {
  const wvlessws = `vless://${userID}@turkey.com:8880?encryption=none&security=none&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
  const pvlesswstls = `vless://${userID}@zula.ir:443?encryption=none&security=tls&type=ws&host=${hostName}&sni=${hostName}&fp=random&path=%2F%3Fed%3D2048#${hostName}`;
