...
const พร็อกซีไอพีs = ['ni.radically.pro', 'usa.revil.link', 'de.radically.pro'];

// if you want to use ipv6 or single พร็อกซีไอพี, please add comment at this line and remove comment at the next line
let พร็อกซีไอพี = พร็อกซีไอพีs[Math.floor(Math.random() * พร็อกซีไอพีs.length)];

let dohURL = 'https://dns.adguard-dns.com/dns-query'; // Or use https://sky.rethinkdns.com/1:-Pf_____9_8A_AMAIgE8kMABVDDmKOHTAKg=  OR  https://cloudflare-dns.com/dns-query OR https://dns.google/dns-query
