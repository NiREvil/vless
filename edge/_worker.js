// Time is 18 Dec 2023 16:32:42 UTC , Edit by NiREvil --> Thanks to 3Kmfi6HP, Dear emotional damage :) --> https://github.com/3Kmfi6HP
// @ts-ignore
import { connect } from 'cloudflare:sockets';

// چطور  UUID خودمونو بگیریم:
// با مراجعه به این سایت : https://www.uuidgenerator.net/  و یا
// [در ویندوز] Press "Win + R", input cmd and run and paste this:  Powershell -NoExit -Command "[guid]::NewGuid()"  بعد جایگذاری کنید یویوآیدی خودتون رو توی سطر زیر بجای ماله من
...
let dohURL = 'https://sky.rethinkdns.com/1:-Pf_____9_8A_AMAIgE8kMABVDDmKOHTAKg='; // میتونید بجای این دی ان اس از واسه کلادفلر یا گوگل هم استفاده کنید که در ادامه نوشته شدن https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						// For any other path, reverse proxy to 'www.ipchicken.com' and return the original response, caching it in the process
						const hostnames = ['www.ipchicken.com','www.udacity.com', 'edtunnel-dgp.pages.dev', 'iplocation.io', 'time.is', 'ip.sb', 'www.wto.org', 'icook.hk', 'skk.moe', 'fbi.gov', 'www.12377.cn'];
