...
const VALID_SS_METHODS = [
    'aes-128-gcm', 'aes-256-gcm', 'chacha20-ietf-poly1305', 'chacha20-ietf', 'xchacha20-ietf-poly1305',
    'aes-128-cfb', 'aes-192-cfb', 'aes-256-cfb', 'aes-128-ctr', 'aes-192-ctr', 'aes-256-ctr',
    'rc4-md5', 'bf-cfb', 'camellia-128-cfb', 'camellia-192-cfb', 'camellia-256-cfb',
    'salsa20', 'chacha20', 'plain', 'none', '2022-blake3-aes-128-gcm', '2022-blake3-aes-256-gcm'
];
...
const genSingboxSubscription = (cfgs) => {
    ...
    return JSON.stringify({
        ...
        "outbounds": [
            { "type": "selector", "tag": "select", "outbounds": ["auto", "direct", ...tags], "default": "auto" },
        ...
        "route": {
            "rules": [
                ...
                { "rule_set": ["geoip-private", "geosite-private", "geosite-ir", "geoip-ir"], "outbound": "direct" },
                { "rule_set": "geosite-ads", "action": "reject" }
            ],
            "rule_set": [
                { "type": "remote", "tag": "geosite-ads", "url": "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geosite/category-ads-all.srs", "download_detour": "direct" },
                { "type": "remote", "tag": "geosite-private", "url": "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geosite/private.srs", "download_detour": "direct" },
                { "type": "remote", "tag": "geosite-ir", "url": "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geosite/category-ir.srs", "download_detour": "direct" },
                { "type": "remote", "tag": "geoip-private", "url": "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geoip/private.srs", "download_detour": "direct" },
                { "type": "remote", "tag": "geoip-ir", "url": "https://testingcf.jsdelivr.net/gh/MetaCubeX/meta-rules-dat@sing/geo/geoip/ir.srs", "download_detour": "direct" }
            ],
            "final": "select",
