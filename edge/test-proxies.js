...
async function main() {
  try {
    ...
    console.log(
      `Job ${chunkIndex + 1}/${totalChunks}: Testing ${ipsToCheck.length} proxies on port 443...`,
    );
    ...
    console.log(
      `Job ${chunkIndex + 1}/${totalChunks} finished. Found ${workingProxies.length} working proxies.`,
    );
