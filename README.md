...
> 
> در [**این قسمت**](#mahsang-gift-codes)، تعدادی کد هدیه از طرف حامیان پروژه مهسا قرار دادم که می‌تونید ازشون استفاده کنید. برای اونایی که نمی‌دونن چطور باید از این کدها استفاده کرد، یه توضیح ساده میدم:
> 
