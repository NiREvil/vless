...
>  
> چند روزه وی‌پی‌ان [Avast SecureLine] خیلی خوب کار می‌کنه با اکثر نت ها مخصوصا همراه اول و ایرانسل و شاتل و مخابرات، تنها کاری که باید کرد اینه که پروتکل رو بذاریم روی Mimic و انتخاب سرور هم اتومات بمونه و بزنیم کانکت شه.  
...
> **نکته:** حواستون باشه سایفون صرفا به درد شرایط جنگی منگی می‌خوره، برای وقتایی که پهنای باند کف زمینه و اختلال بی‌نهایت. برای مواقع عادی خوب نیست، نه سرعت دانلود و آپلود مناسبی داره و نه کیفیت آی‌پی داره.
>
...
>
> فقط دو دسته از آدمها هستن که از Mahsa VPN استفاده نمیکنن:
>
> 1. **کصخل‌ها**
> 2. **عرزشی‌عای شل‌مغز**
>
> هر آدم عاقلی می‌دونه که پروژه مهسا شاهکاره، و بخاطر اوپن سورس بودن و پرفورمنس بالایی که داره و زیر سایه تغییرات فوق‌العاده‌ای که این تیم روی هسته انجام دادن و متناسب با شرایط فیلترینگ کشورمون شد و هم‌چنبن برای حمایت از توسعه دهندگانی که چندسال اخیر توی خط مقدم بدون پشتوانه خاصی بدون داشتن درآمدی حتی بدون دونیت خالصانه پروژه رو پیش بردن، له احترام این گروه باید کلاه از سر برداشت و تعظیم کرد 🩶✋🏿.
>
> اینجا [در این قسمت](#mahsang-gift-codes) من تعدادی کد هدیه از طرف اهداکنندگان پروژه مهسا قرار دادم که می‌تونید ازشون استفاده کنید، یه توضیح کوتاه میدم برای اونایی که نمی‌دونن نحوه استفاده از کد چجوریه.
>
> خیلی ساده بعد از وارد شدن به اپ مهسا از بالای صفحه روی آیکون باکس هدیه کلیک کرده و کد اهداکننده دلخواهتون رو وارد کنید، همین. ،اصلا اینکارو نکردید هم نکردید، مهم نیست، صرفا پایین صفحه کلیک کنید روی Get config تا کانفیگ‌های جدید و سالم برسه به دستتون ✋🏿
>
> <img width="840" alt="MahsaNG-Gift" src="https://github.com/user-attachments/assets/03bcb63b-e7a1-443f-9734-fe507346048f" />
>
> <br/>
>
> یه ویدئو کوتاه هم بچه‌ها گرفته بودن از نسخه 12 و مراحل وارد شدن و دربافت کانفیگ و تست پینگ و غیره ذو توضیح میدن.
>
